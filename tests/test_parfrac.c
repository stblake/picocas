...
void test_apart_basic(void) {
    struct {
        ...
        {"Apart[(x^5-2)/((1+x+x^2)(2+x)(1-x))]", "2 - x + (-1 - 1/3 x)/(1 + x + x^2) + 1/9/(-1 + x) - 34/9/(2 + x)"},
        {"Apart[1/(1-x^3)]", "(2/3 + 1/3 x)/(1 + x + x^2) - 1/3/(-1 + x)"},
        {"Apart[16x/((1+x)^2*(5+x))]", "-4/(1 + x)^2 + 5/(1 + x) - 5/(5 + x)"},
        {"Apart[1/((x+a)*(x+b)*(x+c))]", "1/((a + x) (-a + b) (-a + c)) + 1/((-a + c) (-b + c) (c + x)) - 1/((-a + b) (b + x) (-b + c))"},
        {"Apart[(x+y)/((x+1)(y+1)(x-y)),x]", "2 y/((1 + y)^2 (x - y)) - (-1 + y)/((1 + x) (1 + y)^2)"},
